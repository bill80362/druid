<div class="p-3 text-gray-900">
    <div class="p-2 ">
        <form method="post" wire:submit="submit()">
            @csrf
            <div class="mb-3">
                <label class="form-label">Meta帳號</label>
                <input type="text" class="form-control" wire:model="meta_id">
                <small class="text-danger">@error('meta_id') {{ $meta_id }} @enderror</small>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" wire:model="member_meta_id">
                <small class="text-danger">@error('member_meta_id') {{ $member_meta_id }} @enderror</small>
            </div>
            <div class="mb-3">
