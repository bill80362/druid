        ...
        <form>
            <div class="row">
                <div class="col-12 col-md-3">
                    <input class="form-control form-control-sm w-100" type="text" wire:model.live="name" placeholder="偵測文字" />
                </div>
                <div class="col-12 col-md-3">
                    <input class="form-control form-control-sm w-100" type="text" wire:model.live="content" placeholder="回應訊息" />
                </div>
        ...
        @foreach ($paginator->items() as $item)
            <tr>
                ...
                <td
                    ...
                    @can('自動回應管理_修改')
                        <a class="btn btn-sm btn-primary" href="{{route('replies.edit',["reply"=>$item->id])}}">編輯</a>
                    @endcan
                </td>
            </tr>
        @endforeach
