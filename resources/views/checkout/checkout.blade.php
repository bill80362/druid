<x-app-layout>
    ...
    <x-slot name="header_tool">
        ...
        <!-- 選擇優惠券 -->
        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#choseCoupon">
            選擇優惠券
        </button>
        <div class="modal modal-lg fade" id="choseCoupon" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
